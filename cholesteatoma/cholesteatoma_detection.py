...
image_validator_model_path = os.path.join(current_dir, 'models/ResNet50_endoscopy_image_validator.h5')
model_path = os.path.join(current_dir, 'models/InceptionV3_cholesteatoma_identifier_pp1.h5')
