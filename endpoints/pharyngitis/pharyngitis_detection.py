...
# File paths
model_path = os.path.join(current_dir, 'models/pharyngitis_model_mobilenetv2.h5')
oral_img_validator_model_path = os.path.join(current_dir, 'models/oral_img_validator_model.h5')
